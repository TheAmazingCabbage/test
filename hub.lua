	...
	local function FXKOK_fake_script() -- Scripthub_2.Smooth GUI Dragging 
	...
	coroutine.wrap(FXKOK_fake_script)()
	local function BYZJVFG_fake_script() -- FeSoldier.Script 
	...
	coroutine.wrap(BYZJVFG_fake_script)()
	local function BHMIBX_fake_script() -- FeCyberSniper.Script 
	...
	coroutine.wrap(BHMIBX_fake_script)()
